...
export class AppComponent  implements OnInit {
  ...
  role = 'ImageWithInfo';
    productListItemsOne= [{ "title": "Premium Handcrafted Collection", "subTitle": "Best for your phone, keys, and wallet together, so you can lose everything at once.", imageUrl: '../assets/collection1.png' },
      ...
      roleOne= 'ImageWithTitle';
          productListItemsTwo: [{ "title": "New Arrivals", imageUrl: '../assets/Image 183.png' },
