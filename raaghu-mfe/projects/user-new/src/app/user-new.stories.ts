...
import { RdsCompUserPermissionsNewComponent } from 'projects/rds-components/src/app/rds-comp-user-permissions-new/rds-comp-user-permissions-new.component';
import { RdsCompUserBasicProfileRightComponent } from 'projects/rds-components/src/app/rds-comp-user-basic-profile-right/rds-comp-user-basic-profile-right.component';
...
export const UserNew = Template.bind({});
UserNew.args = {
    userHeaders: [
        {
          key: 'name',
