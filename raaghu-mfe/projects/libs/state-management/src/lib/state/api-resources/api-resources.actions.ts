...
export const getAllApiResources = createAction(
  '[Api-Resources Page] Get All Api-Resources'
);
...
export const getAllApiResourcesEdit = createAction(
  '[Api-Resources] Get All Api-Resources Edit'
);
...
export const getApiResource = createAction(
  '[Api-Resources Page] Get Api-Resource',
  (id: any) => ({ id })
);
...
export const updateApiResource = createAction(
  '[Api-Resources Page] Update Api-Resource',
  (data: any) => ({data})
  );
