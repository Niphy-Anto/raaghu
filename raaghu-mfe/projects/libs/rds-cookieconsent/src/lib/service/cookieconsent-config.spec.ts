...
describe('cookieconsent-config', () => {
    it('should have sensible default values', () => {
        const config = new RdsCookieConsentConfig();
    ...
    it('should have sensible "content" default values', () => {
        ...
        config.content = new RdsContentOptions();
    ...
    it('should have sensible "cookie" default values', () => {
        ...
        config.cookie = new RdsCookieOptions();

        expect(config.cookie.name).toEqual('rds_cookie_status');
    ...
    it('should have sensible "elements" default values', () => {
        ...
        config.elements = new RdsHTMLElements();
    ...
    it('should have sensible "location" default values', () => {
        ...
        config.location = new RdsLocationOptions();
    ...
    it('should have sensible "palette" default values', () => {
        ...
        config.palette = new RdsPaletteOptions();
