...
import { RdsCookieConsentModule } from './../rds-cookieconsent.module';
import { RdsCookieConsentService } from './cookieconsent.service';
...
const minimumConfig: RdsCookieConsentConfig = {
  cookie: {
    domain: 'my.domain.com',
  },
};

const myConfig: RdsCookieConsentConfig = {
  cookie: {
    domain: 'custom.domain.com',
    expiryDays: 250,
    name: '[custom]rds_cookie_status',
    path: '/custom/path'
  },
  content: {
    ...
    deny: '[custom]Decline cookies',
    link: '[custom]Learn more',
    href: 'https://raaghu.io/[custom]',
    close: '&#x2789;'
  },
  palette: {
    popup: {
...
describe('Service: RdsCookieConsent', () => {
  ...
  it('should create the service instance from providers...', () => {
    TestBed.configureTestingModule({
      providers: [WindowService, RdsCookieConsentService, RdsCookieConsentConfig]
    });
    const service = TestBed.inject(RdsCookieConsentService); // inject the service from root injector
  ...
  it('should create the service instance from module imports...', () => {
    TestBed.configureTestingModule({
      imports: [RdsCookieConsentModule.forRoot(minimumConfig)]
    });
  ...
  it('should inject the default RdsCookieConsent UI when injecting the service without config', () => {
    TestBed.configureTestingModule({
      imports: [RdsCookieConsentModule.forRoot(minimumConfig)]
    });
    const service = TestBed.inject(RdsCookieConsentService); // inject the service from root injector
  ...
  it('should inject a custom RdsCookieConsent UI when injecting the service with custom config', () => {
    TestBed.configureTestingModule({
      imports: [RdsCookieConsentModule.forRoot(myConfig)]
    });
    TestBed.inject(RdsCookieConsentService); // inject the service from root injector
  ...
  it('should not inject the RdsCookieConsent UI when not injecting the service', () => {
    TestBed.configureTestingModule({
      imports: [RdsCookieConsentModule.forRoot(minimumConfig)]
    });
  ...
  it('should emit initializing$ event when calling onInitialise() callback', () => {
    ...
    service.initializing$.subscribe((event: RdsInitializingEvent) => {
      calls++;
  ...
  xit('should emit statusChange$ event when calling onStatusChange() callback', () => {
    ...
    service.statusChange$.subscribe((event: RdsStatusChangeEvent) => {
      calls++;
  ...
  it('should emit noCookieLaw$ event when calling onNoCookieLaw() callback', () => {
    ...
    let calls = 0;
    service.noCookieLaw$.subscribe((event: RdsNoCookieLawEvent) => {
      calls++;
  ...
  it('should destroy the RdsCookieConsent UI when calling "destroy"', () => {
    TestBed.configureTestingModule({
      imports: [RdsCookieConsentModule.forRoot(minimumConfig)]
    });
    const service = TestBed.inject(RdsCookieConsentService); // inject the service from root injector
  ...
  it('should toggle RevokeButton the RdsCookieConsent UI when clicking "deny"', fakeAsync(() => {
    TestBed.configureTestingModule({
      imports: [RdsCookieConsentModule.forRoot(myConfig)]
    });
    TestBed.inject(RdsCookieConsentService); // inject the service from root injector
  ...
  it('should fade in the RdsCookieConsent UI when calling "fadeIn"', () => {
    TestBed.configureTestingModule({
      imports: [RdsCookieConsentModule.forRoot(minimumConfig)]
    });
    const service = TestBed.inject(RdsCookieConsentService); // inject the service from root injector
  ...
  it('should fade out the RdsCookieConsent UI when calling "fadeOut"', () => {
    TestBed.configureTestingModule({
      imports: [RdsCookieConsentModule.forRoot(minimumConfig)]
    });
    const service = TestBed.inject(RdsCookieConsentService); // inject the service from root injector
...
/**
 * Utility class to access ui elements related to the RdsCookieConsent.
 */
